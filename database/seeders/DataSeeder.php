...
class DataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 2. Settings
        // -------------------------------------------------------------------
        // Same rows as the Next.js app's db/seed/settings.sql.
        $settingsData = [
        ...
        $emailTemplatesData = [
            ...
            [
                ...
                'title' => 'Notification',
                'subject' => '{{title}}',
                'body' => '<p><strong>{{title}}</strong></p><p>{{body}}</p><p><a href="{{link}}">View details</a></p>',
                'params' => 'title,body,link,app_name',
                'created_at' => '2026-01-07 11:36:05',
                'updated_at' => '2026-01-07 11:36:05',
            ],
        ];
        ...
        $seoData = [
            ...
            [
                ...
                'meta_description' => 'Read our latest articles on AI, machine learning, and technology.',
                'priority' => 0.8,
                'status' => 1,
                'sitemap_enable' => 1,
            ],
