    ...
    public function run(): void
    {
        ...
        $emailTemplatesData = [
            ...
            [
                ...
                'params' => 'first_name,last_name,otp,message',
                'created_at' => '2026-01-07 11:36:05',
                'updated_at' => '2026-01-07 11:36:05',
            ],
            [
                'key' => 'admin_contact',
        ...
        $pagesData = [
            [
                ...
                'created_at' => '2026-06-10 13:14:32',
                'updated_at' => '2026-06-10 13:14:32',
            ],
            [
                'slug' => 'privacy-policy',
                'title' => 'Privacy Policy',
                'body' => 'Privacy Policy Page',
                'created_at' => '2026-06-09 13:24:47',
                'updated_at' => '2026-06-09 13:24:47',
            ],
        ];
        ...
        $seoData = [
            [
                ...
                'priority' => 1,
                'sitemap_enable' => 1,
                'created_at' => '2025-01-17 10:14:40',
                'updated_at' => '2026-06-16 06:15:16',
            ],
            [
                'url' => 'contact',
                'title' => 'Contact',
                ...
                'sitemap_enable' => 1,
                'created_at' => '2025-01-17 10:14:40',
                'updated_at' => '2026-06-16 06:15:28',
            ],
            [
                'url' => 'blog',
                'title' => 'Blog',
                'keyword' => 'Blog, AI, Machine Learning',
                'description' => 'Read our latest articles on AI, machine learning, and technology.',
                'last_modified' => '2026-06-16 06:15:28',
                'change_frequency' => 'Select Frequency',
                'priority' => 1,
                'sitemap_enable' => 1,
                'created_at' => '2026-01-17 10:14:40',
                'updated_at' => '2026-06-16 06:15:28',
            ],
            [
                'url' => 'blog/*',
        ...
        $blogsData = [
            [
                ...
                'excerpt' => 'A deep dive into the transformer architecture, the foundational model behind GPT, BERT, and nearly every modern large language model.',
            ...
            [
                ...
                'excerpt' => 'Master the art of crafting effective prompts for large language models with these proven techniques and patterns.',
            ...
            [
                ...
                'excerpt' => 'Learn how to build Retrieval-Augmented Generation systems that combine the power of LLMs with your own data for accurate, grounded responses.',
            ...
            [
                ...
                'excerpt' => 'Exploring the critical challenges of bias in AI systems and practical strategies for building fairer, more equitable models.',
            ...
            [
                ...
                'excerpt' => 'From autonomous vehicles to medical imaging, discover how computer vision is being deployed at scale across industries.',
                ...
                'status' => 'active',
                'created_at' => '2026-02-28 08:30:00',
                'updated_at' => '2026-02-28 08:30:00',
            ],
            [
                'slug' => 'fine-tuning-llms-custom-data',
                'title' => 'Fine-Tuning Large Language Models on Custom Data: When and How',
                'excerpt' => 'A practical guide to deciding when fine-tuning is worth it versus prompt engineering, and how to do it effectively.',
            ...
            [
                ...
                'excerpt' => 'Most NLP research focuses on English, but the real world speaks 7,000+ languages. Here is how to build AI that works globally.',
            ...
            [
                ...
                'excerpt' => 'From autocomplete to autonomous coding agents, AI code generation is reshaping software development workflows.',
            ...
            [
                ...
                'title' => 'Reinforcement Learning in Robotics: From Simulation to the Real World',
                'excerpt' => 'How reinforcement learning is enabling robots to learn complex tasks through trial and error, and the sim-to-real transfer challenge.',
            ...
            [
                ...
                'excerpt' => 'Understanding vector databases, embedding spaces, and similarity search — the backbone of modern AI-powered search and retrieval.',
            ...
            [
                ...
                'excerpt' => 'Breaking down how diffusion models like Stable Diffusion and DALL-E work, from the noise process to the denoising magic.',
            ...
            [
                ...
                'excerpt' => 'Accuracy alone is misleading. Learn the metrics, techniques, and pitfalls of evaluating ML models for real-world deployment.',
            ...
            [
                ...
                'excerpt' => 'Deploying AI models on phones, IoT devices, and edge servers for low-latency, private, offline-capable inference.',
            ...
            [
                ...
                'excerpt' => 'Understanding the architecture behind AI agents that can plan, use tools, and complete multi-step tasks autonomously.',
            ...
            [
                ...
                'excerpt' => 'From rule-based systems to transformer models, how sentiment analysis has evolved and how to implement it effectively.',
            ...
            [
                ...
                'excerpt' => 'Practical guidelines for engineering teams to build AI systems that are safe, transparent, and accountable.',
            ...
            [
                ...
                'excerpt' => 'Tracing the YOLO family from v1 to the latest versions, and why it remains the go-to choice for real-time object detection.',
                'body' => '<p>YOLO (You Only Look Once) transformed object detection by framing it as a single regression problem rather than a multi-stage pipeline. Since its 2015 debut, the YOLO family has set the standard for real-time detection.</p><p><strong>Key innovations across versions:</strong> YOLOv1 introduced single-shot detection. YOLOv2 added anchor boxes. YOLOv3 used multi-scale predictions with a feature pyramid. YOLOv4 introduced CSPNet backbone and mosaic augmentation. YOLOv5 brought PyTorch accessibility. Later versions continued pushing the speed-accuracy frontier.</p><p><strong>Architecture:</strong> Modern YOLO models use a backbone (feature extraction from input images), a neck (feature aggregation across scales using FPN/PAN), and a head (prediction of bounding boxes, objectness scores, and class probabilities). The single-stage design processes the entire image in one forward pass.</p><p><strong>Deployment:</strong> YOLO\'s speed makes it ideal for edge deployment. Models can be exported to ONNX, TensorRT, CoreML, and TFLite. Typical inference times range from 1-10ms on GPU, enabling 100+ FPS real-time detection for applications like surveillance, autonomous driving, and industrial inspection.</p>',
                'category' => 'computer-vision',
                'status' => 'active',
            ...
            [
                ...
                'excerpt' => 'How artificial intelligence is transforming medical diagnosis, drug discovery, and personalized treatment recommendations.',
            ...
            [
                ...
                'excerpt' => 'How AI-enabled collaborative robots are working alongside humans in factories, warehouses, and laboratories.',
            ...
            [
                ...
                'excerpt' => 'The rise of AI models that process text, images, audio, and video simultaneously — and why multimodality matters.',
        ...
        $this->command?->info('Seeded blogs.');
    }
}