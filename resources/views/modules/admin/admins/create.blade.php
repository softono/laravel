...
@endsection
@section('content')
    <x-ui.page-header title="Admin" :crumbs="[['Dashboard', route('admin/dashboard')], ['Admins', route('admin/admin')], ['Admin Create']]" />
    <x-ui.card>
        <x-ui.card-header>
            <x-ui.card-title class="text-lg">Admin Create</x-ui.card-title>
        </x-ui.card-header>
        <x-ui.card-content>
