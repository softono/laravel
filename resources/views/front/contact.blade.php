...
@endsection
@section('content')
    <h4 class="text-xl font-bold py-3 mb-4">Contact</h4>
        ...
        <div class="card-body">
            ...
            <form class="ajax-contact-form" id="form" method="post" action="{{ route('contact-process') }}">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label class="form-label" for="basic-icon-default-fullname">Subject <span
                                class="text-rose-600">*</span></label>
                        <input type="text" class="form-input" placeholder="Subject"
                            name="subject" required>
                    </div>
                    <div>
                        <label class="form-label" for="basic-icon-default-fullname">Message <span
                                class="text-rose-600">*</span></label>
